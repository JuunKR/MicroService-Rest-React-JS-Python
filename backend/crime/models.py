...
정해진 예산안에서 구별로 다음해 배분하는 기준을 마련하시오.
예산 금액 입력하면, 구당 할당되는 CCTV 카운터를 자동으로 
알려주는 AI 프로그램을 작성하시오.
...
class Service(Reader):
    ...
    def save_police_norm(self):
        ...
        for i in self.crime_rate_columns:
            police.loc[police[i] > 100, 1] = 100 # 데이터 값의 기간 오류로 100을 넘으면 100으로 계산
